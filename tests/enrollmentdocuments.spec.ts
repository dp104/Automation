...
test('Dashboard test', async({page}) => {
    ...
    if (await page.url().includes('dashboard')){
        ...
        await page.getByTitle(/View Details/).nth(5).click();
        ...
        await newpage.getByText('Enrollment Documents',{exact:true}).click();
        // await newpage.waitForTimeout(3000);
        console.log('Enrollment Documents tab are open');
    }
});