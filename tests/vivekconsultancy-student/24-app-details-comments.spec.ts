...
test('Vivek Consultancy — App Details: Comments Tab', async ({ page }) => {
    ...
    await page.locator('.app-details-2-form-textarea').fill('Good Evening – ' + new Date().toISOString().substring(0, 10));
    ...
    const commentInFeed = feedAfter?.includes('Test comment');
